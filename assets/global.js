  ...
  countryHandler: function (e) {
    ...
    if (provinces && provinces.length == 0) {
      ...
      for (var i = 0; i < provinces.length; i++) {
        var option = document.createElement("option"); // Renamed from opt to avoid redeclaration
...
class BulkAdd extends HTMLElement {
  constructor() {
    super();
    this.queue = [];
    this.ASYNC_REQUEST_DELAY = BulkAdd.ASYNC_REQUEST_DELAY; // Reference static property
...
// Add static property in ES5-compatible way
BulkAdd.ASYNC_REQUEST_DELAY = 250;
...
// Add static property in ES5-compatible way
CartPerformance.METRIC_PREFIX = "cart-performance";
